...
//   BLUE = "linear-gradient(35deg, #5e72e4 0, #825ee4 100%) !important",
...
//   RED = "linear-gradient(35deg, #f5365c 0, #f56036 100%) !important",
//   ORANGE = "linear-gradient(35deg, #fb6340 0, #fbb140 100%) !important",
//   YELLOW = "linear-gradient(35deg, #ffd600 0, #beff00 100%) !important",
//   GREEN = "linear-gradient(35deg, #2dce89 0, #2dcecc 100%) !important",
//   TEAL = "linear-gradient(35deg, #11cdef 0, #1171ef 100%) !important",
